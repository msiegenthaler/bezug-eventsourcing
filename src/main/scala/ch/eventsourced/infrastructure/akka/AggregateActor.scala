...
import scalaz._
import ch.eventsourced.api.{EventData, AggregateType}
...
class AggregateActorManager[I, C, E](contextName: String,
  ...
  type Execute = ch.eventsourced.infrastructure.akka.Execute[Command, Error]
...
object AggregateActor {
  ...
  case class EventEmitted[+Event](sequence: Long, event: Event)
}